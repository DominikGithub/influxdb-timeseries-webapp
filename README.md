...
```
cd existing_repo
git remote add origin https://gitlab.com/DominikGitlab/tools-influxdb-vuejs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/DominikGitlab/tools-influxdb-vuejs/-/settings/integrations)
